"""The starter set: eight pies and the F3-F9 binds, as data.

Seeded on a truly fresh install by migrate, wipe-and-seeded into the dev
profile by dev/demo_seed.py, and merged into a real profile by
dev/install_seed.py. Real command names throughout, so everything fires.
"""
from . import model
from .model import ANY_SCOPE, Binding, Pie
